 ...
 * payload 를 담지 않습니다.
 *
 * auth 가 담지 않는 이유는 그쪽 payload 에 이메일과 닉네임이 들어 있어서입니다.
 * 이 서비스의 payload 는 petId 와 accountId 와 판정 관련 여부 셋뿐이라 그런 값이 없습니다.
 *
 * 그래도 담지 않습니다. 관리자가 재발행을 누르는 데 필요한 것은 식별자뿐입니다.
 ...
 * @param aggregateType 집합체 종류입니다. 이 서비스에서는 Pet 뿐입니다.
 * @param aggregateId   어느 반려동물에 대한 이벤트인지입니다.
